...
def test_sorting_disjoint_bounds():
    bounds = [WavelengthBound(2, 3), WavelengthBound(0.1, 1)]

    assert sorted(bounds) == [WavelengthBound(0.1, 1), WavelengthBound(2, 3)]


def test_sorting_overlapping_bounds():
    bounds = [WavelengthBound(2, 3), WavelengthBound(1, 2)]

    assert sorted(bounds) == [WavelengthBound(1, 2), WavelengthBound(2, 3)]
...
def test_two_overlapping_and_one_disjoint():
    bounds = [WavelengthBound(2, 3), WavelengthBound(5, 7), WavelengthBound(1, 3)]
