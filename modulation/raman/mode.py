...
class Mode(abc.ABC):
    ...
    def info(self) -> si.Info:
        ...
        info.add_field(
            ...
            fmt.quantity(self.mode_volume_inside_resonator, fmt.VOLUME_UNITS),
        )
        info.add_field(
            "Mode Volume Outside Resonator",
            fmt.quantity(self.mode_volume_outside_resonator, fmt.VOLUME_UNITS),
        )
