...
class RamanSimulationPlotter:
    ...
    def mode_magnitudes_vs_time(
        ...
        **kwargs,
        ...
        si.vis.xy_plot(
            ...
            x,
            *y,
            line_labels=[fr"${self.sim.spec.modes[q].tex}$" for q in mode_numbers],
            line_kwargs=[
    ...
    def mode_energies_vs_time(
        ...
        **kwargs,
        ...
        x = self.sim.times
        y = [
            self.sim.mode_energies(self.sim.mode_amplitudes_vs_time)[:, q]
    ...
    def mode_output_powers_vs_time(
        ...
        **kwargs,
        ...
        x = self.sim.times
        y = [
            self.sim.mode_output_powers(self.sim.mode_amplitudes_vs_time)[:, q]
            for q in mode_numbers
        ]
    ...
    def mode_pump_powers_vs_time(
        ...
        **kwargs,
        ...
        si.vis.xy_plot(
            ...
            self.sim.times,
            *[
                self.sim.spec.mode_pumps[q].get_power(self.sim.times)
                for q in mode_numbers
            ],
            line_labels=[fr"${self.sim.spec.modes[q].tex}$" for q in mode_numbers],
            line_kwargs=[
