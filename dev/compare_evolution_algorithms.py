...
def compare(dt, method):
    with LOGMAN as logger:
        ...
        si.vis.xy_plot(
            f"compare__dt={dt / u.psec:.3f}ps__method={method.__name__}",
            srs.times,
...
if __name__ == "__main__":
    ...
    for dt, method in itertools.product(dts, methods):
        compare(dt, method)
